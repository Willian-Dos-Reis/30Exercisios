...
export const getMovies = async (path) =>{
    try {
    //const guardadno a url
    let url = `https://api.themoviedb.org/3/movie/550?api_key=6f18e7b560e9d377244216ad6b35d8a2${path}`;
    // const esperando a fect a resposta da url 
    const response = await fetch(url)
    //retornando a response em json 
